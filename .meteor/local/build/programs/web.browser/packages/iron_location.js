...
Location.start = function () {                                                                              // 183
  ...
  Meteor.startup(function () {                                                                              // 227
    $(document).on('click.iron-location', Location.options.linkSelector, fireOnClick);                      // 228
                                                                                                            ...
                                                                                                            // 231
/**                                                                                                         // 232
 * Stop the Location from listening for url changes.                                                        // 233
 */                                                                                                         // 234
Location.stop = function () {                                                                               // 235
  if (!this._isStarted)                                                                                     // 236
    return;                                                                                                 // 237
                                                                                                            // 238
  $(window).on('popstate.iron-location');                                                                   // 239
  $(window).on('hashchange.iron-location');                                                                 // 240
  $(document).off('click.iron-location');                                                                   // 241
                                                                                                            // 242
  this._isStarted = false;                                                                                  // 243
};                                                                                                          // 244
                                                                                                            // 245
/**                                                                                                         // 246
 * Assign a different click handler.                                                                        // 247
 */                                                                                                         // 248
Location.onClick = function (fn) {                                                                          // 249
  onClickHandler = fn;                                                                                      // 250
};                                                                                                          // 251
                                                                                                            // 252
/**                                                                                                         // 253
 * Go to a new url.                                                                                         // 254
 */                                                                                                         // 255
Location.go = function (url, options) {                                                                     // 256
  return go(url, options);                                                                                  // 257
};                                                                                                          // 258
                                                                                                            // 259
/**                                                                                                         // 260
 * Run the supplied callback whenever we "go" to a new location.                                            // 261
 *                                                                                                          // 262
 * Argument: cb - function, called with no arguments,                                                       // 263
 * `this` is the state that's being set, _may_ be modified.                                                 // 264
 */                                                                                                         // 265
Location.onGo = function (cb) {                                                                             // 266
  handlers.go.push(cb);                                                                                     // 267
};                                                                                                          // 268
                                                                                                            // 269
/**                                                                                                         // 270
 * Run the supplied callback whenever we "popState" to an old location.                                     // 271
 *                                                                                                          // 272
 * Argument: cb - function, called with no arguments,                                                       // 273
 * `this` is the state that's being set, _may_ be modified.                                                 // 274
 */                                                                                                         // 275
Location.onPopState = function (cb) {                                                                       // 276
  handlers.popState.push(cb);                                                                               // 277
};                                                                                                          // 278
                                                                                                            // 279
/**                                                                                                         // 280
 * Automatically start Iron.Location                                                                        // 281
 */                                                                                                         // 282
Location.start();                                                                                           // 283
                                                                                                            // 284
/*****************************************************************************/                             // 285
