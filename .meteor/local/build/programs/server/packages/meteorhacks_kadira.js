...
Kadira.connect = function(appId, appSecret, options) {                                                                // 16
  ...
  options.thresholds = options.thresholds || {};                                                                      // 22
                                                                                                                      // 23
  // remove trailing slash from endpoint url (if any)                                                                 // 24
  if(_.last(options.endpoint) === '/') {                                                                              // 25
    options.endpoint = options.endpoint.substr(0, options.endpoint.length - 1);                                       // 26
  }                                                                                                                   // 27
                                                                                                                      // 28
  // error tracking is enabled by default                                                                             // 29
  if(options.enableErrorTracking === undefined) {                                                                     // 30
    options.enableErrorTracking = true;                                                                               // 31
  }                                                                                                                   // 32
                                                                                                                      // 33
  Kadira.options = options;                                                                                           // 34
  Kadira.options.authHeaders = {                                                                                      // 35
    'KADIRA-APP-ID': Kadira.options.appId,                                                                            // 36
    'KADIRA-APP-SECRET': Kadira.options.appSecret                                                                     // 37
  };                                                                                                                  // 38
                                                                                                                      // 39
  Kadira.syncedDate = new Ntp(options.endpoint);                                                                      // 40
  Kadira.syncedDate.sync();                                                                                           // 41
  Kadira.models.methods = new MethodsModel(options.thresholds.methods);                                               // 42
  Kadira.models.pubsub = new PubsubModel();                                                                           // 43
  Kadira.models.system = new SystemModel();                                                                           // 44
  Kadira.models.error = new ErrorModel(appId);                                                                        // 45
                                                                                                                      // 46
  // handle pre-added filters                                                                                         // 47
  var addFilterFn = Kadira.models.error.addFilter.bind(Kadira.models.error);                                          // 48
  Kadira.errors.forEach(addFilterFn);                                                                                 // 49
  Kadira.errors = Kadira.models.error;                                                                                // 50
                                                                                                                      // 51
  // setting runtime info, which will be sent to kadira                                                               // 52
  __meteor_runtime_config__.kadira = {                                                                                // 53
    appId: appId,                                                                                                     // 54
    endpoint: options.endpoint                                                                                        // 55
  };                                                                                                                  // 56
                                                                                                                      // 57
  if(options.enableErrorTracking) {                                                                                   // 58
    Kadira.enableErrorTracking();                                                                                     // 59
  } else {                                                                                                            // 60
    Kadira.disableErrorTracking();                                                                                    // 61
  }                                                                                                                   // 62
                                                                                                                      // 63
  if(appId && appSecret) {                                                                                            // 64
    options.appId = options.appId.trim();                                                                             // 65
    options.appSecret = options.appSecret.trim();                                                                     // 66
    Kadira._pingToCheckAuth(function(){                                                                               // 67
      // it takes time to calculate version 'sha' values                                                              // 68
      // it'll be ready when Meteor.startup is called                                                                 // 69
      Meteor.startup(Kadira._sendAppStats);                                                                           // 70
      Kadira._schedulePayloadSend();                                                                                  // 71
    });                                                                                                               // 72
    logger('connected to app: ', appId);                                                                              // 73
  } else {                                                                                                            // 74
    throw new Error('Kadira: required appId and appSecret');                                                          // 75
  }                                                                                                                   // 76
                                                                                                                      // 77
  //start wrapping Meteor's internal methods                                                                          // 78
  Kadira._startInstrumenting(function() {                                                                             // 79
    console.log('Kadira: completed instrumenting the app')                                                            // 80
    Kadira.connected = true;                                                                                          // 81
  });                                                                                                                 // 82
                                                                                                                      // 83
  Meteor.publish(null, function () {                                                                                  // 84
    var options = __meteor_runtime_config__.kadira;                                                                   // 85
    this.added('kadira_settings', Random.id(), options);                                                              // 86
    this.ready();                                                                                                     // 87
  });                                                                                                                 // 88
};                                                                                                                    // 89
                                                                                                                      // 90
//track how many times we've sent the data (once per minute)                                                          // 91
Kadira._buildPayload = function () {                                                                                  // 92
  var payload = {host: hostname};                                                                                     // 93
  var buildDetailedInfo = Kadira._isDetailedInfo();                                                                   // 94
  _.extend(payload, Kadira.models.methods.buildPayload(buildDetailedInfo));                                           // 95
  _.extend(payload, Kadira.models.pubsub.buildPayload(buildDetailedInfo));                                            // 96
  _.extend(payload, Kadira.models.system.buildPayload());                                                             // 97
  if(Kadira.options.enableErrorTracking) {                                                                            // 98
    _.extend(payload, Kadira.models.error.buildPayload());                                                            // 99
  }                                                                                                                   // 100
                                                                                                                      // 101
  return payload;                                                                                                     // 102
}                                                                                                                     // 103
                                                                                                                      // 104
Kadira._countDataSent = 0;                                                                                            // 105
Kadira._detailInfoSentInterval = Math.ceil((1000*60) / Kadira.options.payloadTimeout);                                // 106
Kadira._isDetailedInfo = function () {                                                                                // 107
  return (Kadira._countDataSent++ % Kadira._detailInfoSentInterval) == 0;                                             // 108
}                                                                                                                     // 109
                                                                                                                      // 110
Kadira.authCheckFailures = 0;                                                                                         // 111
Kadira._pingToCheckAuth = function (callback) {                                                                       // 112
  var httpOptions = {headers: Kadira.options.authHeaders, data: {}};                                                  // 113
  var endpoint = Kadira.options.endpoint + '/ping';                                                                   // 114
  var authRetry = new Retry({                                                                                         // 115
    minCount: 0, // don't do any immediate retries                                                                    // 116
    baseTimeout: 5 * 1000                                                                                             // 117
  });                                                                                                                 // 118
                                                                                                                      // 119
  new Fibers(function() {                                                                                             // 120
    HTTP.call('POST', endpoint, httpOptions, function(err, response){                                                 // 121
      if(response) {                                                                                                  // 122
        if(response.statusCode == 200) {                                                                              // 123
          console.log('Kadira: successfully authenticated');                                                          // 124
          authRetry.clear();                                                                                          // 125
          callback();                                                                                                 // 126
        } else if(response.statusCode == 401) {                                                                       // 127
          console.error('Kadira: authentication failed - check your appId & appSecret')                               // 128
        } else {                                                                                                      // 129
          retryPingToCheckAuth();                                                                                     // 130
        }                                                                                                             // 131
      } else {                                                                                                        // 132
        retryPingToCheckAuth();                                                                                       // 133
      }                                                                                                               // 134
    });                                                                                                               // 135
  }).run();                                                                                                           // 136
                                                                                                                      // 137
  function retryPingToCheckAuth(){                                                                                    // 138
    console.log('Kadira: retrying to authenticate');                                                                  // 139
    authRetry.retryLater(Kadira.authCheckFailures, function(){                                                        // 140
      Kadira._pingToCheckAuth(callback);                                                                              // 141
    });                                                                                                               // 142
  }                                                                                                                   // 143
}                                                                                                                     // 144
                                                                                                                      // 145
Kadira._sendAppStats = function () {                                                                                  // 146
  var appStats = {};                                                                                                  // 147
  appStats.release = Meteor.release;                                                                                  // 148
  appStats.packageVersions = [];                                                                                      // 149
  appStats.appVersions = {                                                                                            // 150
    webapp: __meteor_runtime_config__['autoupdateVersion'],                                                           // 151
    refreshable: __meteor_runtime_config__['autoupdateVersionRefreshable'],                                           // 152
    cordova: __meteor_runtime_config__['autoupdateVersionCordova']                                                    // 153
  }                                                                                                                   // 154
                                                                                                                      // 155
  // TODO get version number for installed packages                                                                   // 156
  _.each(Package, function (v, name) {                                                                                // 157
    appStats.packageVersions.push({name: name, version: null});                                                       // 158
  });                                                                                                                 // 159
                                                                                                                      // 160
  Kadira._send({                                                                                                      // 161
    host: hostname,                                                                                                   // 162
    startTime: new Date(),                                                                                            // 163
    appStats: appStats                                                                                                // 164
  });                                                                                                                 // 165
}                                                                                                                     // 166
                                                                                                                      // 167
Kadira._schedulePayloadSend = function () {                                                                           // 168
  setTimeout(function () {                                                                                            // 169
    Kadira._sendPayload(Kadira._schedulePayloadSend);                                                                 // 170
  }, Kadira.options.payloadTimeout);                                                                                  // 171
}                                                                                                                     // 172
                                                                                                                      // 173
Kadira._sendPayload = function (callback) {                                                                           // 174
  new Fibers(function() {                                                                                             // 175
    var payload = Kadira._buildPayload();                                                                             // 176
    Kadira._send(payload, function (err) {                                                                            // 177
      if(err) {                                                                                                       // 178
        console.error('Kadira: Error sending payload (dropped after 5 tries)', err.message);                          // 179
      }                                                                                                               // 180
                                                                                                                      // 181
      callback && callback();                                                                                         // 182
                                                                                                                      ...
                                                                                                                      // 186
Kadira._send = function (payload, callback) {                                                                         // 187
  var endpoint = Kadira.options.endpoint;                                                                             // 188
  var httpOptions = {headers: Kadira.options.authHeaders, data: payload};                                             // 189
  var payloadRetries = 0;                                                                                             // 190
  var payloadRetry = new Retry({                                                                                      // 191
    minCount: 0, // don't do any immediate payloadRetries                                                             // 192
    baseTimeout: 5*1000,                                                                                              // 193
    maxTimeout: 60000                                                                                                 // 194
  });                                                                                                                 // 195
                                                                                                                      // 196
  callHTTP();                                                                                                         // 197
                                                                                                                      // 198
  function callHTTP() {                                                                                               // 199
    new Fibers(function() {                                                                                           // 200
      HTTP.call('POST', endpoint, httpOptions, function(err, response){                                               // 201
        if(response && response.statusCode === 401) {                                                                 // 202
          // do not retry if authentication fails                                                                     // 203
          throw new Error('Kadira: AppId, AppSecret combination is invalid');                                         // 204
        }                                                                                                             // 205
                                                                                                                      // 206
        if(response && response.statusCode == 200) {                                                                  // 207
          if(payloadRetries > 0) {                                                                                    // 208
            logger('connected again and payload sent.')                                                               // 209
          }                                                                                                           // 210
          cleaPayloadRetry();                                                                                         // 211
          ...
          tryAgain(err);                                                                                              // 214
                                                                                                                      ...
                                                                                                                      // 219
  function tryAgain(err) {                                                                                            // 220
    err = err || {};                                                                                                  // 221
    logger('retrying to send payload to server')                                                                      // 222
    if(++payloadRetries < 5) {                                                                                        // 223
      payloadRetry.retryLater(payloadRetries, callHTTP);                                                              // 224
    } else {                                                                                                          // 225
      cleaPayloadRetry();                                                                                             // 226
      callback && callback(err);                                                                                      // 227
    }                                                                                                                 // 228
  }                                                                                                                   // 229
                                                                                                                      // 230
  function cleaPayloadRetry() {                                                                                       // 231
    payloadRetries = 0;                                                                                               // 232
    payloadRetry.clear();                                                                                             // 233
  }                                                                                                                   // 234
}                                                                                                                     // 235
                                                                                                                      // 236
// this return the __kadiraInfo from the current Fiber by default                                                     // 237
// if called with 2nd argument as true, it will get the kadira info from                                              // 238
// Meteor.EnvironmentVariable                                                                                         // 239
//                                                                                                                    // 240
// WARNNING: returned info object is the reference object.                                                            // 241
//  Changing it might cause issues when building traces. So use with care                                             // 242
Kadira._getInfo = function(currentFiber, useEnvironmentVariable) {                                                    // 243
  currentFiber = currentFiber || Fibers.current;                                                                      // 244
  if(currentFiber) {                                                                                                  // 245
    if(useEnvironmentVariable) {                                                                                      // 246
      return Kadira.env.kadiraInfo.get();                                                                             // 247
    }                                                                                                                 // 248
    return currentFiber.__kadiraInfo;                                                                                 // 249
  }                                                                                                                   // 250
};                                                                                                                    // 251
                                                                                                                      // 252
// this does not clone the info object. So, use with care                                                             // 253
Kadira._setInfo = function(info) {                                                                                    // 254
  Fibers.current.__kadiraInfo = info;                                                                                 // 255
};                                                                                                                    // 256
                                                                                                                      // 257
Kadira.enableErrorTracking = function () {                                                                            // 258
  __meteor_runtime_config__.kadira.enableErrorTracking = true;                                                        // 259
  Kadira.options.enableErrorTracking = true;                                                                          // 260
};                                                                                                                    // 261
                                                                                                                      // 262
Kadira.disableErrorTracking = function () {                                                                           // 263
  __meteor_runtime_config__.kadira.enableErrorTracking = false;                                                       // 264
  Kadira.options.enableErrorTracking = false;                                                                         // 265
};                                                                                                                    // 266
                                                                                                                      // 267
Kadira.trackError = function (type, message, options) {                                                               // 268
  if(Kadira.options.enableErrorTracking && type && message) {                                                         // 269
    options = options || {};                                                                                          // 270
    options.subType = options.subType || 'server';                                                                    // 271
    options.stacks = options.stacks || '';                                                                            // 272
    var error = {message: message, stack: options.stacks};                                                            // 273
    var trace = {                                                                                                     // 274
      type: type,                                                                                                     // 275
      subType: options.subType,                                                                                       // 276
      name: message,                                                                                                  // 277
      errored: true,                                                                                                  // 278
      at: Kadira.syncedDate.getTime(),                                                                                // 279
      events: [['start', 0, {}], ['error', 0, {error: error}]],                                                       // 280
      metrics: {total: 0}                                                                                             // 281
    };                                                                                                                // 282
    Kadira.models.error.trackError(error, trace);                                                                     // 283
  }                                                                                                                   // 284
}                                                                                                                     // 285
                                                                                                                      // 286
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
process.on('uncaughtException', function (err) {                                                                      // 1
  ...
  Kadira._sendPayload(function () {                                                                                   // 15
